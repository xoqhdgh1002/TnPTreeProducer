...
registerOption('inputs',  '',    'Input name', optionType=VarParsing.varType.string)
registerOption('outputs',  '',    'Output name', optionType=VarParsing.varType.string)
...
options['OUTPUT_FILE_NAME']     = varOptions.outputs 
...
if '2016' in options['era']:
  ...
  options['HLTFILTERSTOMEASURE']= {"passHltEle27WPTightGsf" :                           cms.vstring("hltEle27WPTightGsfTrackIsoFilter"),
                                   ...
                                   "passHltEG42Iso50T80LCaloId24b40eHE10R9Id65Eta2HcalIsoLastFilter" : cms.vstring("hltEG42Iso50T80LCaloId24b40eHE10R9Id65Eta2HcalIsoLastFilter"),
                                   "passHltEG25Iso50T80LCaloId24b40eHE10R9Id65TrackIsoUnseededLastFilter" : cms.vstring("hltEG25Iso50T80LCaloId24b40eHE10R9Id65TrackIsoUnseededLastFilter"),
  ...
  options['HLTFILTERSTOMEASURE']= {"passHltEle32DoubleEGWPTightGsf" :                   cms.vstring("hltEle32L1DoubleEGWPTightGsfTrackIsoFilter"),
                                   ...
                                   "passHltDoubleEle33CaloIdLMWUnsLeg" :                cms.vstring("hltDiEle33CaloIdLMWPMS2UnseededFilter"),
                         				   "passHltEG60R9Id90CaloIdLIsoLDisplacedI" :		cms.vstring("hltEG60R9Id90CaloIdLIsoLDisplacedIdFilter"),
                        				   "passHltPFHT350Jet15" :				cms.vstring("hltPFHT350Jet15"),
...
options['INPUT_FILE_NAME'] = cms.untracked.vstring(varOptions.inputs)
