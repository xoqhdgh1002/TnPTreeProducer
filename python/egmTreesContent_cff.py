...
#    el_dEtaSeeOut       = cms.string("deltaEtaSeedClusterTrackAtCalo"),
    ...
    el_ecalPFClusterIso = cms.string("ecalPFClusterIso"),
    el_hcalPFClusterIso = cms.string("hcalPFClusterIso"),
    # el_trkSumPtHollowConeDR03 = cms.string("trkSumPtHollowConeDR03"),
    )
...
# need to fill
    ...
    ph_ecalPFClusterIso = cms.string("ecalPFClusterIso"),
    ph_hcalPFClusterIso = cms.string("hcalPFClusterIso"),
