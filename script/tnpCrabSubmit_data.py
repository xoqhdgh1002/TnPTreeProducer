...
mainOutputDir = '/cms_scratch/taebh/test/%s' % submitVersion
...
if __name__ == '__main__':
    ...
    config.JobType.pyCfgParams  = ['isMC=False','isAOD=False',doEleTree,doPhoTree,doHLTTree,doRECO,'GT=124X_dataRun3_PromptAnalysis_v1']
